...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ResourceGroupIdentityIntf) DeepCopyInto(out *ResourceGroupIdentityIntf) {
	*out = *in
	if in.Href != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ResourceGroupIdentityIntf.
func (in *ResourceGroupIdentityIntf) DeepCopy() *ResourceGroupIdentityIntf {
	if in == nil {
		return nil
	}
	out := new(ResourceGroupIdentityIntf)
	in.DeepCopyInto(out)
	return out
}
