...
func (in *CloudantDatabaseParameters) DeepCopyInto(out *CloudantDatabaseParameters) {
	*out = *in
	if in.CloudantAdminURL != nil {
		in, out := &in.CloudantAdminURL, &out.CloudantAdminURL
		*out = new(string)
		**out = **in
	}
	if in.CloudantAdminURLRef != nil {
		in, out := &in.CloudantAdminURLRef, &out.CloudantAdminURLRef
		*out = new(corev1alpha1.Reference)
		**out = **in
	}
	if in.CloudantAdminURLSelector != nil {
		in, out := &in.CloudantAdminURLSelector, &out.CloudantAdminURLSelector
